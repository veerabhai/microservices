...
/**
 * Implementation that maps the "note" table in the database to an entity in the ORM world.
 *
 * @author Editor
 */
...
@Table(name = "note")
@Entity
public class NoteEntity extends AbstractIdGeneratedEntity<Integer> {
