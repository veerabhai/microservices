...
/**
 * Implementation that maps the "media_type" table in the database to an entity in the ORM world.
 *
 * @author Editor
 */
...
@Entity
public class MediaTypeEntity extends AbstractIdGeneratedEntity<Integer> {
